                ...
                <div className="carousel-inner slider ">
                    <div className="carousel-item active bg-dark position-relative text-center">
                        ...
                        <div className="carousel-caption  d-block position-absolute top-50 start-50 translate-middle">
                            ...
                            <h1 className='permanent-marker-font slider-large-txt'>MAKE YOURSELF <span className='bluish-font'>AT Home</span></h1>
                    ...
                    <div className="carousel-item bg-dark">
                        ...
                        <div className="carousel-caption d-block position-absolute top-50 start-50 translate-middle">
                            ...
                            <h1 className='permanent-marker-font slider-large-txt'>Redefine Your <span className='greeny-text'>Expectations</span></h1>
                    ...
                    <div className="carousel-item bg-black">
                        ...
                        <div className="carousel-caption d-block position-absolute top-50 start-50 translate-middle">
                            ...
                            <h1 className='permanent-marker-font slider-large-txt'><span className='orange-text'>Thermal</span> Baths</h1>
